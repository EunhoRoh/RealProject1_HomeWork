...
public class Main {
	...
	public static void main(String[] args) {
		...
		fl.add(new Fruit(104,"Pair", 3000));
		fl.add(new Fruit(105,"Mango", 5000));
		fl.add(new Fruit(106,"StrawBerry", 2500));
		fl.add(new Fruit(107,"WaterMelon", 10000));
		fl.add(new Fruit(108,"PaPaYa", 3000));
		fl.add(new Fruit(109,"MangoStin", 4000));
		fl.add(new Fruit(110,"StarFruit", 2000));
